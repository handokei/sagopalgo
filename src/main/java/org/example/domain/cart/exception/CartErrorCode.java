...
public enum CartErrorCode implements ErrorCode{
    ...
    NOT_SALE_PRODUCT_QUANTITY_CHANGE_EXCEPTION(HttpStatus.UNAUTHORIZED, "판매중인 상품이 아닙니다." ),
    NOT_SALE_PRODUCT_INVALID_ADD_CART_EXCEPTION(HttpStatus.UNAUTHORIZED,"판매중인 상품만 장바구니에 담을 수 있습니다." );
