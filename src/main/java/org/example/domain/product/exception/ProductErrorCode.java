...
public enum ProductErrorCode implements ErrorCode {
    PRODUCT_NOT_FOUND_EXCEPTION(HttpStatus.NOT_FOUND, "상품이 존재하지 않습니다."),
    DUPLICATE_PRODUCT_TITLE(HttpStatus.CONFLICT, "동일한 상품명의 제품이 존재합니다."),
    VALID_NON_ZERO_PRICE(HttpStatus.BAD_REQUEST, "금액은 0원이상이여야합니다."),
    VALID_NON_ZERO_STOCK(HttpStatus.BAD_REQUEST, "재고는 1개 이상이여야 합니다."),
    INVALID_OUT_OF_STOCK_STATUS_CHANGE(HttpStatus.BAD_REQUEST, "재고를 수정하여야 상태변경이 가능합니다."),
